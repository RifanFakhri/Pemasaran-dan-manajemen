...
<div class="w-full px-6 py-6 mx-auto">
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        ...
                        <div class="px-3 text-right basis-1/3">
                            ...
                            <i class="fas fa-regular fa-house-circle-check text-lg relative top-2.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                            <i class="fas fa-solid fa-house-circle-xmark text-lg relative top-2.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="col-span-1">
            @livewire('admin.produk-terlaris')
        </div>
        
        <!-- Kolom Kanan - Status Pemesanan -->
        <div class="col-span-1">
            @livewire('admin.status-pemesanan')
        </div>
    </div>
</div>
