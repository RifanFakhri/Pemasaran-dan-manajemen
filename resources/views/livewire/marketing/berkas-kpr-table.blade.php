...
<div class="bg-gray-50 p-4 rounded-lg mb-4">
    ...
    <div class="flex justify-center mt-3 space-x-3">
        <a href="{{ route('marketing.tambah-berkas') }}" class="bg-teal-600 hover:bg-teal-700 text-white text-sm font-semibold px-2 py-2 rounded-lg shadow">
                + Tambah berkas
            </a>
                    ...
                    {{ $item->created_at->format('d/m/Y') }} <!-- Format tanggal -->
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <!-- Tombol Edit -->
                                <a href="{{ route('marketing.edit-berkas', $item->id) }}" 
