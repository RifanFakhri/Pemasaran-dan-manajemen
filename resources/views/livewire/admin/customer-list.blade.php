<div class="w-full px-6 py-6 mx-auto overflow-hidden">
    <div class="px-6 pt-2">
        ...
        <div class="flex items-center justify-between mt-2 mb-6">
            ...
            <a href="{{ Auth::user()->role === 'admin' ? route('admin.tambahPengguna') : route('marketing.tambahPengguna') }}"
                class="bg-teal-600 hover:bg-teal-700 text-white text-sm font-semibold px-2 sm:px-8 py-2 rounded-lg shadow">
                Tambah Pengunjung
            </a>
        </div>
    </div>
                                    ...
                                    @foreach ($customers as $customer)
                                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                               <a href="{{ Auth::user()->role === 'admin' ? route('admin.editCustomer', $customer->id) : route('marketing.editCustomer', $customer->id) }}" 
                                                    class="text-sm text-white bg-teal-600 hover:bg-teal-700 px-3 py-1 rounded-xl">Edit</a>
                                            </td>
                                            <td class="px-6 py-4 text-center"> 
                                                @php
